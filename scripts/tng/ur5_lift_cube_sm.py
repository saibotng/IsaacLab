...
from isaaclab_tasks.manager_based.tng_ur5.ur5_lift.lift_env_cfg import LiftEnvCfg
...
def main():
    ...
    env_cfg: LiftEnvCfg = parse_env_cfg(
        "TNG-Lift-Cube-UR5-IK-Abs-v0",
        device=args_cli.device,
        num_envs=args_cli.num_envs,
        use_fabric=not args_cli.disable_fabric,
    )
    # create environment
    env = gym.make("TNG-Lift-Cube-UR5-IK-Abs-v0", cfg=env_cfg)
